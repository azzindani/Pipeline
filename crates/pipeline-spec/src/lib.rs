//! `pipeline-spec` — STUB. Layout locked at POC scaffold, ✗ implemented.
//!
//! kind: component
//! status: stub
//! charter: `OpenAPI` · `JSONSchema` · Protobuf · `AsyncAPI` generation + registry
//! implemented-in: handlers/docs.rs
//!
