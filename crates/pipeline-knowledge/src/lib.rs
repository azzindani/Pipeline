//! `pipeline-knowledge` — STUB. Layout locked at POC scaffold, ✗ implemented.
//!
//! kind: component
//! status: stub
//! charter: knowledge export/import · LLM context packaging
//! implemented-in: handlers/memory.rs
//!
